                ...
                <c:forEach items="${resumes}" var="resume">
                    ...
                    <tr class="t-body">
                        <td class="name-column">
                            <a class="text-table-anchor"
                               href="resume?uuid=${resume.uuid}&action=view&theme=${theme}">${resume.fullName.replace(" ", "</br>")}</a>
                        </td>
                        <td class="info-column">
                            <a class="text-table-anchor" href="<%=ContactType.MAIL.getHref(resume.getContact(ContactType.MAIL))%>">
                                    ${resume.getContact(ContactType.MAIL)}
                                <br>
                                    ${resume.getContact(ContactType.MOBILE)}
                            </a>
                        </td>
                        <td class="img-column">
